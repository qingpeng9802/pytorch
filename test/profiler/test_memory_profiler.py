...
class TestMemoryProfilerE2E(TestCase):
    ...
    def test_categories_e2e_simple_fwd_bwd(self) -> None:
        ...
        self.assertExpectedInline(
            ...
            aten::binary_cross_entropy_with_logits   7 (INPUT), 2 (INPUT)                          -> 12 (INPUT)

            -- Backward ---------------------------------------------------------------------------------------------
            aten::ones_like                          12 (INPUT)                                    -> 15 (INPUT)
            aten::sigmoid                            7 (INPUT)                                     -> 16 (TEMPORARY)
            aten::sub.Tensor                         16 (TEMPORARY), 2 (INPUT)                     -> 17 (TEMPORARY)
            aten::mul.Tensor                         17 (TEMPORARY), 15 (INPUT)                    -> 18 (AUTOGRAD_DETAIL)
            aten::div_.Scalar                        18 (AUTOGRAD_DETAIL)                          -> 18 (AUTOGRAD_DETAIL)
            aten::slice.Tensor                       18 (AUTOGRAD_DETAIL)                          -> 18 (AUTOGRAD_DETAIL)
            aten::slice.Tensor                       18 (AUTOGRAD_DETAIL)                          -> 18 (AUTOGRAD_DETAIL)
            aten::mul.Tensor                         18 (AUTOGRAD_DETAIL), 1 (INPUT)               -> 21 (AUTOGRAD_DETAIL)
            aten::sum.dim_IntList                    21 (AUTOGRAD_DETAIL)                          -> 22 (GRADIENT)
            aten::view                               22 (GRADIENT)                                 -> 22 (GRADIENT)
            aten::detach                             22 (GRADIENT)                                 -> 22 (GRADIENT)
            aten::detach                             22 (GRADIENT)                                 -> ???
            aten::mul.Tensor                         18 (AUTOGRAD_DETAIL), 1 (INPUT)               -> 23 (AUTOGRAD_DETAIL)
            aten::sum.dim_IntList                    23 (AUTOGRAD_DETAIL)                          -> 24 (GRADIENT)
            aten::view                               24 (GRADIENT)                                 -> 24 (GRADIENT)
            aten::detach                             24 (GRADIENT)                                 -> 24 (GRADIENT)
    ...
    def test_categories_e2e_simple_fwd_bwd_step(self) -> None:
        ...
        self.assertExpectedInline(
            ...
            aten::binary_cross_entropy_with_logits   7 (ACTIVATION), 2 (INPUT)                     -> 12 (ACTIVATION)

            -- Backward ---------------------------------------------------------------------------------------------
            aten::ones_like                          12 (ACTIVATION)                               -> 15 (ACTIVATION)
            aten::sigmoid                            7 (ACTIVATION)                                -> 16 (TEMPORARY)
            aten::sub.Tensor                         16 (TEMPORARY), 2 (INPUT)                     -> 17 (TEMPORARY)
            aten::mul.Tensor                         17 (TEMPORARY), 15 (ACTIVATION)               -> 18 (AUTOGRAD_DETAIL)
            aten::div_.Scalar                        18 (AUTOGRAD_DETAIL)                          -> 18 (AUTOGRAD_DETAIL)
            aten::slice.Tensor                       18 (AUTOGRAD_DETAIL)                          -> 18 (AUTOGRAD_DETAIL)
            aten::slice.Tensor                       18 (AUTOGRAD_DETAIL)                          -> 18 (AUTOGRAD_DETAIL)
            aten::mul.Tensor                         18 (AUTOGRAD_DETAIL), 1 (INPUT)               -> 21 (AUTOGRAD_DETAIL)
            ...
            -- Optimizer --------------------------------------------------------------------------------------------
            aten::add_.Tensor                        3 (PARAMETER), 24 (GRADIENT)                  -> 3 (PARAMETER)
            aten::add_.Tensor                        5 (PARAMETER), 22 (GRADIENT)                  -> 5 (PARAMETER)""",
        )
